...
case class LambdaPermission(lambdaResourceName: String, statementId: String, principal: String, functionName: TValue, qualifer: TValue, sourceArn: TValue) extends Resource {
  /**
