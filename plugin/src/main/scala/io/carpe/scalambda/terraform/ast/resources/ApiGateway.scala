...
case class ApiGateway(apiName: TValue, description: Option[String], swaggerFile: TDataRef) extends Resource {
  /**
   * Examples: "aws_lambda_function" "aws_iam_role"
   */
  override def resourceType: Option[String] = Some("aws_api_gateway_rest_api")
